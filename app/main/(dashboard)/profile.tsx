  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#fff" }}>
      ...
      >
        ...
        >
          <SvgXml xml={user.avatar} width="80" height="80" />
        ...
        <View style={{ alignItems: "center", gap: 5 }}>
          ...
          <View style={{ alignItems: "center", gap: 5, flexDirection: "row" }}>
            ...
            >
              <Text style={{ fontSize: 16, color: "#666" }}>{user.bio}</Text>
            </TouchableHighlight>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          onPress={() => {
            // setShowQrModal(true)
            router.push("/main/(dashboard)/(profile)/qr-scan");
          }}
        >
          <QrCode />
        </TouchableOpacity>
